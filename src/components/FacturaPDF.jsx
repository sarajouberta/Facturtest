/*Nota: usa estilos en línea (style={{...}}) con colores hex, no Tailwind, para
  ...
  function FacturaPDF({ factura, config }) {
    ...
    const box = { border: '1px solid #333', padding: '8px', boxSizing:
  'border-box' }
    const th = { border: '1px solid #333', padding: '4px 6px', background:
  '#eee', textAlign: 'left' }
...
{/* Trabajos realizados */}
  ...
  '12px' }}>
          <thead>
            <tr>
              <th style={{ ...th, width: '70px', textAlign: 'right'
  }}>Cantidad</th>
              <th style={th}>Descripción</th>
              <th style={{ ...th, width: '90px', textAlign: 'right'
  }}>Importe</th>
            </tr>
          </thead>
          <tbody>
